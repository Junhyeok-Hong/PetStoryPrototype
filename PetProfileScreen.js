...
export default function PetProfileScreen({ navigation }) {
  const vaccination_data = DATA[0].vaccination_data;
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].name} </Text>
        </View>

        <Text style={styles.textStyle}> Animal: </Text>

        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].animal} </Text>
        </View>

        <Text style={styles.textStyle}> Breed: </Text>

        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].breed} </Text>
        </View>

        <Text style={styles.textStyle}> Gender: </Text>

        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].gender} </Text>
        </View>

        <Text style={styles.textStyle}> Weight: </Text>

        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].weight} </Text>
        </View>

        <Text style={styles.textStyle}> Birth Date: </Text>

        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].birth_date} </Text>
        </View>
        ...
        <View style={styles.inputView}>
          <Text style={styles.TextInput}> {DATA[0].notes} </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
